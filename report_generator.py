...
def generate_readable_report(job: dict) -> str:
    ...
    if deepfake_pct > authentic_pct:
        recommendation = "⚠️ POTENTIAL DEEPFAKE DETECTED"
    ...
    report = f"""
🛡️ DEEPFAKE DETECTION ANALYSIS REPORT
{'='*60}
...
• Deepfake Probability: {deepfake_pct:.1f}%
...
• Facial artifact detection and inconsistency analysis
• Temporal coherence verification in video content
• Lighting and shadow consistency evaluation
• Skin texture and facial feature analysis
• Boundary detection around manipulated regions
...
{'-'*30}"""
    ...
    if deepfake_pct > authentic_pct:
        report += """
⚠️ CAUTION: Potential synthetic content detected
• Verify content through additional sources
• Consider the context and origin of this media
• Do not use for critical decision-making without verification
• Be aware of potential manipulation
• Cross-reference with original content if available"""
    else:
        report += """
✅ Content appears to be authentic
• However, no detection system is 100% accurate
• Always consider source and context
• Sophisticated deepfakes may evade detection
• Use additional verification methods when critical
• Stay updated with latest detection technologies"""
